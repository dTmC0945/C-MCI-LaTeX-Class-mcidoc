...
calculated for frequencies in the range of \qtyrange{100}{4000000}{\hertz} are considered to be
...
\lstinputlisting[linerange={6-32},language=C++,caption={Descriptive Caption Text}]{codes/string_comparator.cpp}
